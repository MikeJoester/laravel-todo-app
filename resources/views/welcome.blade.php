            ...
            @if (Route::has('login'))
                <nav class="sm:fixed z-10 flex flex-row justify-between w-full">
                    ...
                    <div class="sm:top-0 p-6 text-right sm:text-base lg:text-xl self-center text-slate-700">
                        @auth
                            <a href="{{ url('/category/index') }}" class="font-semibold hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Start Now</a>
                        @else
                  ...
                  <div class="text-center">
                    <div class="block rounded-lg bg-[hsla(0,0%,100%,0.8)] px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-[hsla(0,0%,15%,0.8)] dark:shadow-black/20 md:py-16 md:px-12"
                      ...
                      <h1 class="mt-6 mb-16 text-5xl font-bold tracking-tight md:text-6xl xl:text-7xl text-white">
                        The best task manager <br /><span class="text-primary">for your business</span>
                      </h1>
                      <a class="mb-2 inline-block rounded bg-slate-500 px-12 pt-4 pb-3.5 text-sm font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:text-black hover:bg-slate-200 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] md:mr-2 md:mb-0"
                        data-te-ripple-init data-te-ripple-color="light" href="{{ route('login') }}" role="button">Get started</a>
                      <a class="inline-block rounded px-12 pt-4 pb-3.5 text-sm font-medium uppercase leading-normal text-white transition duration-150 ease-in-out hover:bg-slate-300 hover:bg-opacity-10 hover:text-primary-600 focus:text-primary-600 focus:outline-none focus:ring-0 active:text-primary-70"
